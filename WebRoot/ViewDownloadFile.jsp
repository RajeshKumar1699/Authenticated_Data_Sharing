...
<th><font color="blue">Download</font></th>
  ...
  <%for(ProfileBean rb:al){ %>
<tr>

 <td>
  <font color="green"><%=rb.getFid()%></font>
</td>
 <td>
  ...
  <td>
  <font color="green"><%=rb.getSub()%></font>
</td> 
...
<font color="green"><a href="F:\<%=rb.getFile()%>"><%=rb.getFile()%></font>
 ...
 --%><td>
<font color="green"><a href="./DownloadLinkServlet?filen=<%=rb.getFilename()%>&sid=<%=rb.getSub()%>">Download</a></font>
</td>
