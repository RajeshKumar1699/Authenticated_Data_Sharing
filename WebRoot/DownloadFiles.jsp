...
<div style="width: 1000px; height: auto; margin-top: -15px;">
  ...
  <%
    ...
    al=(ArrayList)session.getAttribute("list3");
     %>
...
<tr>
<th><font color="blue" >FId</font></th>
...
<tr>
<td>
  <font color="green"><%=pb.getFid()%></font>
</td>
...
<td>
<font color="green"><%=pb.getSub()%></font>
</td>
  
 
   <td>
<font color="green"><a href="F:\<%=pb.getFile()%>"><%=pb.getFile()%></font>
</td>
