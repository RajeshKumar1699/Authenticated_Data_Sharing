...
<div style="width: 1000px; height: auto; margin-top: -15px;">
			...
			<center>
  <%
    ArrayList<ProfileBean> all=new ArrayList<ProfileBean>();
    all=(ArrayList)session.getAttribute("list7");
     %>
   ...
   <center><h1><font style="color: rgb(0, 0, 136)" face="Algerian">Download Message</font></h1></center>
...
<th><font color="blue">Message</font></th>

  </tr>
 
  <% for(ProfileBean pb:all){ %>
...
<td>
<font color="green"><%=pb.getMessage()%></font>
</td>
